...
namespace gc {
    ...
    //     field(const root_handle<T> &handle) : handle(internal::ToField(handle)) {}
    //     field(const root_handle<std::remove_const_t<T>> &handle) requires(std::is_const_v<T>) : handle(internal::ToField(handle)) {}
    //     template <bool ro>
    //     field(const pin<T, ro> &pin) : handle(internal::ToField(pin)) {}
    //     template <bool ro>
    //     field(const pin<std::remove_const_t<T>, ro> &pin) requires(std::is_const_v<T>) : handle(internal::ToField(pin)) {}
    //
    //     field(const field &other) : handle(internal::Copy(other.handle, handle_role::field, handle_role::field)) {}
    //     field(const field<std::remove_const_t<T>> &other) requires(std::is_const_v<T>) : handle(internal::Copy(other.handle, handle_role::field, handle_role::field)) {}
    //     field &operator=(const field &other) {
    //         if (&other == this) {
    //             return *this;
    //         }
    //
    //         handle = internal::Copy(other.handle, handle_role::field, handle_role::field);
    //         return *this;
    //     }
    //
    ...
    //     }
    //
    //     constexpr field &operator=(std::nullptr_t) noexcept {
    //         if (handle != nullptr) {
    //             internal::Destroy(handle, handle_role::field);
    //         }
    //
    //         handle = nullptr;
    //         return *this;
    //     }
    //
    //     constexpr field &operator=(null_handle_t) noexcept {
    //         if (handle != nullptr) {
    //             internal::Destroy(handle, handle_role::field);
    //         }
    //
